...
function FoundPetCard({ pet }) {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden border-l-4 border-green-500">
      ...
      <div className="p-4">
        <div className="mb-4">
          <h2 className="text-xl font-bold mb-1 text-green-700">{pet.name}</h2>
        ...
        <div className="bg-green-50 p-3 rounded mb-4">
          <h4 className="font-semibold text-green-700 mb-2">Found Information</h4>
          <p className="text-sm text-gray-700 mb-1">
            <span className="font-medium">Date:</span> {new Date(pet.foundDate).toLocaleDateString()}
          </p>
          <p className="text-sm text-gray-700 mb-1">
            <span className="font-medium">Time:</span> {pet.foundTime}
          </p>
          <p className="text-sm text-gray-700">
            <span className="font-medium">Location:</span> {pet.foundLocation}
          </p>
        </div>

        <div className="bg-blue-50 p-3 rounded mb-4">
          <h4 className="font-semibold text-blue-700 mb-2">Current Location</h4>
          <p className="text-sm text-gray-700">{pet.currentLocation}</p>
        </div>
        ...
        <div className="bg-yellow-50 p-3 rounded mb-4">
          <h4 className="font-semibold text-yellow-700 mb-2">Finder Contact</h4>
          <p className="text-sm text-gray-700 mb-1">
        ...
        <div className="flex gap-2">
          <Link 
            to={`/pet/${pet.id}`} 
            className="flex-1 bg-green-500 text-white px-4 py-2 rounded text-center hover:bg-green-600 transition-colors"
          >
            View Details
          </Link>
          <button 
