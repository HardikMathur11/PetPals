...
function LostPet() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!user) {
      setError("Please login to report a lost pet");
      setLoading(false);
      return;
    }
    ...
    try {
      const petWithUserData = {
        ...petData,
        ownerId: user.uid,
        ownerName: user.displayName || `${userProfile?.firstName} ${userProfile?.lastName}`,
      ...
      setError("Failed to report lost pet. " + err.message);
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-md text-center">
          ...
          <p className="text-gray-600 mb-4">Please login to report a lost pet.</p>
          <button 
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-red-600 mb-2">Report Lost Pet</h1>
            <p className="text-gray-600">Help us find your beloved pet. Provide as much detail as possible.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <h2 className="text-xl font-semibold mb-4 text-gray-800">Last Seen Information</h2>
              ...
              <textarea
                ...
                value={petData.lastSeenLocation}
                onChange={handleChange}
                rows="3"
                required
              />
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <textarea
                name="description"
                placeholder="Detailed description of your pet *"
                className="w-full mb-4 px-4 py-2 border rounded focus:outline-none focus:border-red-500"
            ...
            <div className="text-center">
              <button
                type="submit"
                disabled={loading}
                className="bg-red-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-red-700 disabled:bg-gray-400"
              >
                {loading ? "Reporting Lost Pet..." : "Report Lost Pet"}
              </button>
            </div>
          </form>
        </div>
